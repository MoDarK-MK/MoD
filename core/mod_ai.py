...
class ConfigExporter:
    ...
    def to_dict(config: ModAIConfig) -> Dict:
        ...
        result = {
            ...
            "status5xx_bonus": config.status5xx_bonus,
            "slow_response_bonus": config.slow_response_bonus,
            "anomaly_bonus_cap": config.anomaly_bonus_cap,
            "fp_penalty_cap": config.fp_penalty_cap,
            "fp_penalty_weight": config.fp_penalty_weight,
            "payload_risk_bonus": config.payload_risk_bonus,
            "keyword_bonus": config.keyword_bonus,
            "high_confidence_floor": config.high_confidence_floor,
            "vuln_type_weights": config.vuln_type_weights,
        }
        return result
